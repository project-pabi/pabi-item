package com.pabi.pabiitem.common.response;


import com.google.common.collect.Lists;
import com.pabi.pabiitem.common.exception.BaseException;
import com.pabi.pabiitem.common.interceptor.CommonHttpRequestInterceptor;
...
public class CommonControllerAdvice {
  ...
  public CommonResponse accessDeniedException(
    ...
    String eventId = MDC.get(CommonHttpRequestInterceptor.HEADER_REQUEST_UUID_KEY);
    log.warn("[AccessDeniedException] eventId = {}, cause = {}, errorMsg = {}", eventId,
        NestedExceptionUtils.getMostSpecificCause(e),
        NestedExceptionUtils.getMostSpecificCause(e).getMessage());
    return CommonResponse.fail(ErrorCode.FORBIDDEN_ERROR);
  }
}